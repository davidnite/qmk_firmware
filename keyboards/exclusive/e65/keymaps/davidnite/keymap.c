...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [OSX] = LAYOUT_65_ansi_blocker_splitbs(
        ...
        KC_NO,   KC_LCTL, KC_LALT,                    KC_SPC,               KC_RALT, KC_RCTRL,          KC_LEFT, KC_DOWN, KC_RGHT),

    [LIN] = LAYOUT_65_ansi_blocker_splitbs(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        KC_LCTL, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, KC_LALT, KC_LGUI,                  _______,                             KC_LGUI, KC_RALT, _______, _______, _______),

    [_ADJUST] = LAYOUT_65_ansi_blocker_splitbs(
        RESET,   LAY_OSX, LAY_LIN, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MO(_ADJUST),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case LAY_LIN:
            if (record->event.pressed) {
                set_single_persistent_default_layer(LIN);
            }
            return false;
            break;
        case RGB_MOD:
