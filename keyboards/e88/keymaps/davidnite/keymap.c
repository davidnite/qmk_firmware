...
[_MA] = LAYOUT_all(
    ...
    MO(_FN),  KC_LGUI,  KC_LALT,                                KC_SPC,                                           KC_RALT,  KC_RALT,  RESET,   KC_RCTRL,   KC_LEFT,  KC_DOWN,  KC_RGHT),
[_FN] = LAYOUT_all(
    ...
    _______,  _______,  _______,                                _______,                                          _______,  _______,  _______,  _______,    G(C(KC_LEFT)),   _______,  G(C(KC_RGHT))),
