...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_base_kit(  
        ...
        C(KC_C), OTHER,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,     KC_ENT,  
        C(KC_V),  KC_LSFT,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,   KC_DOT,    KC_SLSH,  KC_RSFT,   
        C(KC_S),  KC_LCTL, KC_LGUI, KC_LALT,                            LT(_LOWER, KC_SPACE),                    RAISE, KC_MENU, OSX
    ),
    ...
    [_OSX] = LAYOUT_base_kit(  
        KC_ESC,  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_MINUS,  KC_BSPC, 
        G(KC_C), OTHER,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,     KC_ENT,  
        G(KC_V),  KC_LSFT,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,   KC_DOT,    KC_SLSH,  KC_RSFT,   
        G(KC_S),  KC_LGUI, KC_LCTL, KC_LALT,                            LT(_LOWER, KC_SPACE),                    RAISE, KC_MENU, XXXXX
    ),
    ...
    [_LOWER] = LAYOUT_base_kit(  
        KC_GRAVE,  XXXXX, KC_1,  KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_UNDS,  KC_DEL, 
    ...
    [_OTHER] = LAYOUT_base_kit(  
        RGB_MOD,  XXXXX,  RGB_VAI,    RGB_HUI,    RGB_SAI,    XXXXX,    XXXXX,    XXXXX,    XXXXX,    XXXXX,    XXXXX,    XXXXX,  KC_BSLS,  XXXXX, 
        XXXXX,  XXXXX,  RGB_VAD,    RGB_HUD,    RGB_SAD,    XXXXX,    XXXXX,    KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT,    XXXXX,     KC_PIPE,  
        XXXXX,  XXXXX,     XXXXX,    XXXXX,    XXXXX,    XXXXX,    XXXXX,    XXXXX,    XXXXX,    G(KC_PGUP),   G(KC_PGDN),    XXXXX,  XXXXX,   
